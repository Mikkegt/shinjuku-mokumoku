...
const connpassEventSettings = {
  ...
  participation: [
    {
      attendeeType: '行きます', maxAttendees: 10, payDoor: true, eventFee: 0, fcfs: true,
    },
    {
      attendeeType: '行くかも', maxAttendees: 3, payDoor: true, eventFee: 0, fcfs: true,
    },
  ],
  ...
  questionnaire: [
    {
      required: true,
      title: '本もくもく会は、slackでcommunicationを取ります。参加日までにサインアップしておくことは出来ますか？',
      answerType: 'radiobutton',
      options: ['問題なく遂行できる', 'やったことないので当日までになんとかしてくる'],
    },
    {
      required: true,
      title: '本もくもく会は、自己紹介と当日やることを記述したPull Requestを**事前に**出すことが求められます。実施することはできますか？',
      answerType: 'radiobutton',
      options: ['問題なく遂行できる', 'やったことないので当日までになんとかしてくる'],
    },
    {
      required: true,
      title: 'もくもくして得た学びや気付き、成果をもくもく会終了時にLTスタイルで1-5min程度のカジュアルに発表します。問題ありませんか？',
      answerType: 'radiobutton',
...
ConnpassEventCreator.create(connpassEventSettings);
